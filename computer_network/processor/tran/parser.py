...
class UDPParser(TransParser):
    ...
    def parse(cls, packet):
        udp_header = cls.parse_udp_header(packet[cls.TRANS_DATA_OFFSET:
                                                 cls.TRANS_DATA_OFFSET + cls.UDP_HEADER_LENGTH])
        data = packet[cls.TRANS_DATA_OFFSET + cls.UDP_HEADER_LENGTH:]
...
class TCPParser(TransParser):
    ...
    @classmethod
    def parse(cls, packet):
        tcp_header = packet[cls.TRANS_DATA_OFFSET:
                            cls.TRANS_DATA_OFFSET + cls.TCP_HEADER_LENGTH]
        data = packet[cls.TRANS_DATA_OFFSET + cls.TCP_HEADER_LENGTH:]
